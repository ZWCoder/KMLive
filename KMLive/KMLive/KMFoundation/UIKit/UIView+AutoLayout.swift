...
public enum XMG_AlignType {
    ...
    case Center
     ...
     func layoutAttributes(isInner: Bool, isVertical: Bool) -> XMG_LayoutAttributes {
        ...
        switch self {
            case .TopLeft:
                ///Result of call to 'verticals(from:to:)' is unused
...
extension UIView {
    ...
    */
    ...
    :returns: 约束数组
    */
    public func xmg_AlignInner(type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint =  CGPoint(x: 0.0, y: 0.0)) -> [NSLayoutConstraint]  {
    ...
    :returns: 约束数组
    */
    public func xmg_AlignVertical(type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint(x: 0.0, y: 0.0)) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    public func xmg_AlignHorizontal( type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint  = CGPoint(x: 0.0, y: 0.0)) -> [NSLayoutConstraint] {
    ...
    */
    public func xmg_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
      ...
      _ =   firstView.xmg_AlignInner(type: XMG_AlignType.TopLeft, referView: self, size: nil, offset: CGPoint(x: insets.left, y: insets.top))
        cons.append(NSLayoutConstraint(item: firstView, attribute: .bottom, relatedBy: NSLayoutRelation.equal, toItem: self, attribute: .bottom, multiplier: 1.0, constant: -insets.bottom))
    ...
    */
    ...
    :returns: 约束数组
    */
     func xmg_sizeConstraints(referView: UIView) -> [NSLayoutConstraint] {
